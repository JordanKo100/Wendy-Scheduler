...
export default function Management() {
    ...
    const fetchBookings = useCallback(async () => {
        try {
            const data = await api.get('/reservations/get-all');
                                ...
                                Object.keys(groupedBookings).map((date) => (
                                    <section key={date}>
                                        <div className="flex items-center mb-4">
                                            ...
                                            <span
                                                className={`px-4 text-sm font-black uppercase tracking-tighter ${
                                                    date === todayLabel
                                                        ? 'text-[#ED1B24]'
                                                        : date === tomorrowLabel
                                                        ? 'text-[#0078c4]'
                                        ...
                                        <div className="grid gap-3">
                                            {groupedBookings[date].map((app) => (
                                                <div
                                                    key={app._id}
                                                    className="group bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-[#FEF200] transition-all flex items-center justify-between"
                                                >
