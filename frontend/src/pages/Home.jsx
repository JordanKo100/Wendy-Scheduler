                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="max-w-xl mt-8">
                        <p className="text-xl leading-relaxed text-gray-900 font-medium mb-8">
                            Providing hair services in the Renfrew Collingwood area for over 10+ years at affordable prices
                            that respect our neighbors.
                        </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center text-xs font-black text-[#0056b3] hover:underline"
                        >
                                ...
                                <div key={h.day} className={today === h.day ? 'scale-105 transition-transform' : ''}>
                                    <p
                                        className={`text-xs font-black uppercase tracking-tighter ${
                                            today === h.day ? 'text-[#ED1B24]' : 'text-gray-400'
                                        }`}
                                    >
                                        {h.day} {today === h.day && '•'}
                                    </p>
                                    <p
                                        className={`text-sm font-bold ${
                                            h.closed ? 'text-red-600 italic' : 'text-gray-800'
                                        }`}
                                    >
                                        {h.time}
                                    </p>
